...
// If you're reading this because you want to automate reading
// to or writing from a world, email me for a scripting license.
...
YourWorld.World = function() {
    ...
    var queueEdit = function (arr) {
        ...
        arr.push("Thanks for not scripting during our open source release! <3");
        _edits.push(arr);
    };
